defmodule Placeholder_1 do
  ...
  defguard placeholder_7(placeholder_8)
           when is_integer(placeholder_8) and rem(placeholder_8, 2) == 0

  defguardp placeholder_9(placeholder_8)
            when is_integer(placeholder_8) and rem(placeholder_8, 2) == 1
